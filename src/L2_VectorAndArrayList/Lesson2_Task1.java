...
/*
Спроектируйте класс, который представляет математический объект вектор
(задается тремя координатами) и содержит методы определяющие основные опреации над векторами.
*/
